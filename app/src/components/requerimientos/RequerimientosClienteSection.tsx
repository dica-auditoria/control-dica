...
function DeadlineBadge({ fecha, extendida }: { fecha: string | null; extendida: boolean }) {
  ...
  if (dias === 0)
    return <span style={{ fontSize: 10, padding: "2px 7px", borderRadius: 100, background: "rgba(200,71,42,0.12)", color: "#C8472A", fontFamily: "'DM Mono', monospace", flexShrink: 0 }}>Vence hoy</span>;
